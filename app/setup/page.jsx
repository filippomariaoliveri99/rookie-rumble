        ...
        <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
          ...
          {confirming === "all" ? (
            <div className="flex items-center gap-2 text-sm">
              ...
              <button onClick={handleResetAll} className="bg-black text-white px-3 py-1 font-semibold hover:bg-neutral-800">Si, reset</button>
          ...
          <div className="mt-6">
            {confirming === "votes" ? (
              <div className="inline-flex items-center gap-2 text-sm">
                ...
                <button onClick={handleResetVotes} className="bg-black text-white px-3 py-1 font-semibold hover:bg-neutral-800">Si, azzera</button>
                <button onClick={() => setConfirming(null)} className="text-neutral-500 hover:text-black px-2">Annulla</button>
              </div>
            ) : (
